...
public class InsertCar extends JFrame {
    ...
    public void setDegign() {
        ...
        String[] color = {"빨강색", "노랑색", "파랑색", "초록색", "검은색", "흰색"};
        jcolor = new JComboBox<>(color);
        jcolor.setBounds(80, 165, 200, 40);
        this.add(jcolor);

        pay = new JTextField();
        pay.setBounds(80, 235, 200, 40);
        this.add(pay);

        fuel = new JTextField();
        fuel.setBounds(80, 305, 200, 40);
        this.add(fuel);
        ...
        btnAdd.setBounds(330, 260, 200, 50);
